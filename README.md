...
In that directory you'll see three files. `index.html`, `main.css`, and this `README.md` with the description of the lab.  Open them in your text editor via your command line.  Also open `index.html` in your browser; if everything is working correctly you should see a white page. Good job!
